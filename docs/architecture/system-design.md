...
| **交互层** | 用户界面、告警通道、API 服务 | React、FastAPI、Webhook |
...
```python
# src/collectors/aliyun_collector.py
...
| 功能 | 优先级 | 说明 |
|-----|-------|------|
| Prometheus 数据采集 | P0 | 基础指标采集 |
| 基础根因分析 | P0 | LLM + 简单提示词 |
| Langfuse 集成 | P0 | 全链路追踪 |
| Webhook 告警接收 | P0 | Alertmanager 对接 |
| 飞书通知 | P0 | 基础通知能力 |
